...
def value_of_card(card):
    ...
    if card in FACE_CARDS:
        ...
        raise ValueError("This is not a valid card.")
...
def value_of_ace(card_one, card_two):
    ...
    if card_one == 'A' or card_two == 'A' or values[0] + values[1] > 10:
        return 1
    else:
        return 11
...
def is_blackjack(card_one, card_two):
    ...
    has_ace = 'A' in cards
    has_ten_value = bool(cards & set(FACE_CARDS + ['10']))
...
def can_double_down(card_one, card_two):
    ...
    return values[0] + values[1] in sums
