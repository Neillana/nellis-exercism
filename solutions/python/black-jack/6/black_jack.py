...
def value_of_card(card: str) -> int:
    ...
    """
    card = card.strip().upper()        # normalize user-input
    ...
    raise ValueError('This is not a valid BlackJack card.')
...
def is_blackjack(card_one: str, card_two: str) -> bool:
    ...
    return 'A' in [card_one, card_two] and value_of_card(card_one) + value_of_card(card_two) == 11
